...
<template>
	 <link href="src/assets/css/account-style.css" rel="stylesheet">
<main>
			...
			<div class="accountForm">
				<div class="accountFormHd">
					<div class="row">
						...
						<div class="col-xs-6 col-md-6 col-lg-6 text-right"><div class="backNav"><i class="fa-regular fa-arrow-left"></i> &nbsp; <a href="events.html">Back to all events</a></div></div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							...
							<form>
										...
										<div class="row">
											...
											<div class="col-xs-6 col-md-6 col-lg-6">
												<p class="forgetmenot text-right"> 
													<label for="rememberme"><a href="#">Forgot Password?</a></label>
												</p>
											</div>
										</div>
								</div>
								...
								<div class="formFieldLogin formFieldCW">
									<div class="row">
										<div class="col-md-12 col-lg-12">
											Or continue with
										</div>
								...
								<div class="formFieldLogin formFieldBottom">
									<div class="row">
										<div class="col-md-12 col-lg-12">
												Dont have and account? <a href="#">Signup</a>
										</div>
									</div>
								</div>
							</form>
